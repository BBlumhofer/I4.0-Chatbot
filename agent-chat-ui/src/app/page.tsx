...
function ThinkingBlock({
  ...
  return (
    <div className="mb-2 overflow-hidden rounded-xl border" style={{ borderColor: "var(--thinking-border, #d8b4fe)", backgroundColor: "var(--thinking-bg, #faf5ff)" }}>
        ...
        {isStreaming ? (
          <span className="flex items-center gap-1.5">
            ...
            <span className="inline-flex gap-0.5">
              <span className="size-1.5 animate-bounce rounded-full" style={{ backgroundColor: "var(--thinking-dot, #a855f7)", animationDelay: "0ms" }} />
              <span className="size-1.5 animate-bounce rounded-full" style={{ backgroundColor: "var(--thinking-dot, #a855f7)", animationDelay: "150ms" }} />
              <span className="size-1.5 animate-bounce rounded-full" style={{ backgroundColor: "var(--thinking-dot, #a855f7)", animationDelay: "300ms" }} />
            </span>
          </span>
        ) : (
      ...
      {isOpen && (
        <div className="px-4 py-3 text-sm whitespace-pre-wrap" style={{ borderTopColor: "var(--thinking-border, #d8b4fe)", borderTopWidth: 1, borderTopStyle: "solid", color: "var(--thinking-text, #7e22ce)" }}>
          {content}
        </div>
      )}
    </div>
